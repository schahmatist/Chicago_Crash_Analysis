...
# chicago_crush_analysis

Phase3 Flatiron Project
...
To create a stand-alone environment named `chicago_crush_analysis` with Python 3 and all the required package versions, run the following:

```bash
$ conda env create -n chicago_crush_analysis -f environment.yml
```
